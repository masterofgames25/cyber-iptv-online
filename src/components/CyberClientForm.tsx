...
const CyberClientForm: React.FC<CyberClientFormProps> = ({
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 0: return renderMainSection();
      case 1: return renderSubscriptionSection();
      case 2: return renderConnectionSection();
      default: return null;
    }
  };
          ...
          <div className="pt-6 border-t border-purple-500/30">
            ...
            <div className="md:hidden flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-3 border border-purple-500/30 rounded-lg hover:bg-purple-500/20 transition-colors flex items-center justify-center gap-2"
              >
                {currentStep === 0 ? (
                  'Cancelar'
                ) : (
              ...
              {currentStep === steps.length - 1 ? (
                <button
                  type="submit"
                  className="flex-1 px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg hover:from-green-400 hover:to-emerald-400 transition-all duration-300 flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-400 hover:to-blue-400 transition-all duration-300 flex items-center justify-center gap-2"
                >
                  Próximo <ArrowRightIcon className="w-4 h-4" />
                </button>
              )}
            </div>
          </div>
